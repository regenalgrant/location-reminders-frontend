...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue:identifier isEqualToString:@"addReminderViewController"] && [sender isKindOfClass:[MKAnntationView class]]] {
            ...
            newReminderViewControlleer.title = annotation.title;
            
            _weak typedef (self) bruce = self;
            
            newReminderViewController.completion = ^(MKCircle *circle) {
                _strong typedef (bruce) hulk = bruce;
                
                [hulk.mapView removeAnnotation: annotationView.annotateion];
